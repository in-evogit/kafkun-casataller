 ...
 * vías del negocio: hacer un pedido y aprender la técnica. Los verbos son distintos a
        ...
        <div className="mt-12 grid gap-10 border-t border-border pt-10 sm:grid-cols-2 sm:gap-16">
          <div>
            ...
            <p className="mt-3 max-w-[42ch] text-[0.9375rem] leading-relaxed text-muted-foreground">
              Nos juntamos por videollamada, vemos medidas y te asesoro completo.
              Recién después de eso hay precio.
            </p>
            <Link
              href="/contacto"
          ...
          <div>
            ...
            <p className="mt-3 max-w-[42ch] text-[0.9375rem] leading-relaxed text-muted-foreground">
              El taller inicial está en preparación. Déjame tu correo y te aviso apenas
              abra.
            </p>
            <Link
              href="/cursos"
